...
RSpec.describe "JSON Schema Draft 7 official suite" do
  ...
  enabled_formats = %w[date date-time ipv4 ipv6 json-pointer relative-json-pointer time]
  format_files = Dir[File.join(suite_root, "tests", "draft7", "optional", "format", "*.json")]
